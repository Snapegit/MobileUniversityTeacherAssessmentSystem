	...
	<view :style='{"minHeight":"100%","width":"100%","padding":"32rpx 20rpx","position":"relative","background":"#E0F0FD"}'>
		<form :style='{"border":"28rpx solid #6AB6EC","padding":"24rpx","borderRadius":"20rpx","background":"#fff","display":"block","width":"100%","height":"auto"}' class="app-update-pv">
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"24rpx","color":"#333","textAlign":"left"}' class="title">标题</view>
				<input :style='{"border":"0","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"#EBEBEB","fontSize":"28rpx","height":"80rpx"}' :disabled="ro.title" v-model="ruleForm.title" placeholder="标题"  type="text"></input>
			</view>
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","height":"auto"}' class=" select">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"24rpx","color":"#333","textAlign":"left"}' class="title">分类名称</view>
				<picker :disabled="ro.typename" :style='{"width":"100%","flex":"1","height":"auto"}' @change="typenameChange" :value="typenameIndex" :range="typenameOptions">
					<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#6AB6EC"}' class="uni-input">{{ruleForm.typename?ruleForm.typename:"请选择分类名称"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"24rpx","color":"#333","textAlign":"left"}' class="title">发布人</view>
				<input :style='{"border":"0","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"#EBEBEB","fontSize":"28rpx","height":"80rpx"}' :disabled="ro.name" v-model="ruleForm.name" placeholder="发布人"  type="text"></input>
			</view>
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","height":"auto"}' class="" @tap="headportraitTap">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","height":"auto"}' class="" @tap="pictureTap">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"24rpx","color":"#333","textAlign":"left"}' class="title">简介</view>
				<textarea :style='{"border":"0","padding":"24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"#EBEBEB","fontSize":"28rpx","height":"240rpx"}' v-model="ruleForm.introduction" placeholder="简介"></textarea>
			</view>
			<view :style='{"width":"100%","padding":"12rpx 0","margin":"0 0 24rpx 0","borderWidth":"0","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","fontWeight":"500"}' class="title">内容</view>
                <xia-editor ref="editor" :style='{"minHeight":"300rpx","border":"0","width":"100%","padding":"12rpx","background":"#EBEBEB","height":"auto"}' v-model="ruleForm.content" placeholder="内容" @editorChange="contentChange"></xia-editor>
			</view>
