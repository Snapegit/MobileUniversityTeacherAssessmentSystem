...
public class PingshichengjiController {
    ...
    public R fenshuSectionStat(HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = pingshichengjiService.fenshuSectionStat(params, ew);
        return R.ok().put("data", result);
    }
    ...
    public R count(@RequestParam Map<String, Object> params,PingshichengjiEntity pingshichengji, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
            pingshichengji.setXuehao((String)request.getSession().getAttribute("username"));
        }
        ...
        EntityWrapper<PingshichengjiEntity> ew = new EntityWrapper<PingshichengjiEntity>();
        int count = pingshichengjiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, pingshichengji), params), params));
