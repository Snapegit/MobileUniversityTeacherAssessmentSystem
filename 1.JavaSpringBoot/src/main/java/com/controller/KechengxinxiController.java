...
public class KechengxinxiController {
    ...
    public R save(@RequestBody KechengxinxiEntity kechengxinxi, HttpServletRequest request){
        if(kechengxinxiService.selectCount(new EntityWrapper<KechengxinxiEntity>().eq("kechengbianhao", kechengxinxi.getKechengbianhao()))>0) {
    ...
    public R update(@RequestBody KechengxinxiEntity kechengxinxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(kechengxinxi);
        if(kechengxinxiService.selectCount(new EntityWrapper<KechengxinxiEntity>().ne("id", kechengxinxi.getId()).eq("kechengbianhao", kechengxinxi.getKechengbianhao()))>0) {
            return R.error("课程编号已存在");
        }
