	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"15px ","background":"#eeeeee"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="url" prop="url">
					<el-input
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}' v-else-if="ruleForm.url" label="url" prop="url">
