<template>
  <div :style='{"padding":"30px","margin":"0","background":"#eeeeee"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="教师姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming"               placeholder="教师姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}' v-if="flag=='jiaoshi'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}' v-if="flag=='jiaoshi'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="职称" prop="zhicheng">
          <el-input v-model="ruleForm.zhicheng"               placeholder="职称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="电话" prop="dianhua">
